...
static const char qt_meta_stringdata_BscanDisplay[] = {
    ...
    "refresh_scan_env()\0flag\0"
    "cursor_visible_changed(bool)\0beams\0"
    ...
    "type\0do_mcu_key_event(Mcu::KeyType)\0"
    "do_cursor_visible_changed(bool)\0"
    "do_ultrasound_reference_changed(double)\0"
    "do_ultrasound_measurement_changed(double)\0"
    "do_scan_reference_changed(double)\0"
    "do_scan_measurement_changed(double)\0"
    "do_value_changed(double)\0"
};
...
void BscanDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->cursor_visible_changed((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 4: _t->do_data_event((*reinterpret_cast< const DplSource::BeamsPointer(*)>(_a[1]))); break;
        case 5: _t->update_sound_path_ruler(); break;
        case 6: _t->do_view_size_changed((*reinterpret_cast< const QSize(*)>(_a[1]))); break;
        case 7: _t->do_refresh_scan_env(); break;
        case 8: _t->do_update_ruler((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 9: _t->do_mcu_key_event((*reinterpret_cast< Mcu::KeyType(*)>(_a[1]))); break;
        case 10: _t->do_cursor_visible_changed((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 11: _t->do_ultrasound_reference_changed((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 12: _t->do_ultrasound_measurement_changed((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 13: _t->do_scan_reference_changed((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 14: _t->do_scan_measurement_changed((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 15: _t->do_value_changed((*reinterpret_cast< double(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 3
void BscanDisplay::cursor_visible_changed(bool _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
