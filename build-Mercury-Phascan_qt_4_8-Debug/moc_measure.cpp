...
#include "../ui/measure_bar/measure.h"
...
static const char qt_meta_stringdata_Measure[] = {
    "Measure\0"
};
...
const QMetaObjectExtraData Measure::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Measure::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Measure,
      qt_meta_data_Measure, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Measure::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Measure))
