...
double Measure::calculate(const DplDevice::GroupPointer &grp, Measure::Type type)
{
...
/*  A%: 闸门 A 中测得的信号的峰值波幅  */
double Measure::gate_a_peak(const DplDevice::GroupPointer &group)
{
    return group->current_beam()->gate_peak(DplSource::Beam::GATE_A);
}

/*  AdBA: 闸门 A 内峰值幅度与闸门阈值幅度之差(dB)  */
double Measure::gate_adBa(const DplDevice::GroupPointer &group)
{
...
/*  B%: 闸门 B 中测得的信号的峰值波幅  */
double Measure::gate_b_peak(const DplDevice::GroupPointer &group)
{
    return group->current_beam()->gate_peak(DplSource::Beam::GATE_B);
}

/*  BdBB: 闸门 B 内峰值幅度与闸门阈值幅度之差(dB)  */
double Measure::gate_bdBb(const DplDevice::GroupPointer &group)
{
...
double Measure::gate_bdBr(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"umimplemented";
    return 0;
}
...
/*  A^: 闸门 A 内的信号峰值位置  */
double Measure::gate_a_position(const DplDevice::GroupPointer &group)
{
...
/*  B^: 闸门 B 内的信号峰值位置  */
double Measure::gate_b_position(const DplDevice::GroupPointer &group)
{
...
/*  I(w)/: 闸门 I 内信号的前沿位置(水) */
double Measure::gate_i_water_position(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented"; // 缺少闸门I内波形前沿的位置
    return 0;
//    double _nMeasureData;
...
/*  T(A^): 厚度  */
double Measure::thickness(const DplDevice::GroupPointer &group)
{
...
/*  ML: 材料损失百分比  */
double Measure::ml(const DplDevice::GroupPointer &group)
{
...
/*  %(r): 参考光标位置的幅度值  */
double Measure::reference_cursor_amplitude(const DplDevice::GroupPointer &group)
{
...
/*  %(m): 测量光标位置的幅度值  */
double Measure::measurement_cursor_amplitude(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
/*  %(m-r): 测量光标减去参考光标的幅度值  */
double Measure::measurement_reference(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
/*  U(r): 参考光标在超声轴上的位置  */
double Measure::reference_cursor_ut_position(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
/*  U(m): 测量光标在超声轴上的位置  */
double Measure::measurement_cursor_ut_position(const DplDevice::GroupPointer &group)
{
//    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
double Measure::measurement_reference_ut_position(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
/*  P(r): 相对于参考光标的探头位置  */
double Measure::reference_cursor_probe_position(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
/*  P(m): 相对于测量光标的探头位置  */
double Measure::measurement_cursor_probe_position(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
double Measure::measurement_reference_probe_position(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
/*  S(r): 扫查轴上参考光标的位置  */
double Measure::reference_cursor_scan_position(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
/*  S(m): 扫查轴上测量光标的位置  */
double Measure::measurement_cursor_scan_position(const DplDevice::GroupPointer &group)
{
//    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
double Measure::measurement_reference_scan_position(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
/*  I(r): 步进轴上的参考光标位置  */
double Measure::reference_cursor_index_position(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
/*  I(m): 步进轴上的测量光标位置  */
double Measure::measurement_cursor_index_position(const DplDevice::GroupPointer &group)
{
//    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
double Measure::measurement_reference_index_position(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
double Measure::ra(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented"; // 缺少PulserWidth(脉宽)和BeamDelay
//    double _nMeasureData;
...
double Measure::rb(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";// 缺少PulserWidth(脉宽)和BeamDelay
//    double _nMeasureData;
...
double Measure::pa(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 10.2;
}
...
double Measure::pb(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
double Measure::da(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 10.1;
}
...
double Measure::db(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
double Measure::sa(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented"; // 缺少PulserWidth(脉宽)和BeamDelay
...
double Measure::sb(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";// 缺少PulserWidth(脉宽)和BeamDelay
//    double _nMeasureData;
...
double Measure::via(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
double Measure::vib(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
double Measure::vsa(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
double Measure::vsb(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
double Measure::la(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";// 缺少PulserWidth(脉宽)，BeamDelay，工件厚度
//    double _nMeasureData;
...
double Measure::lb(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";// 缺少PulserWidth(脉宽)，BeamDelay，工件厚度
    return 0;
}
...
/*  E%: 闸门 A 中包络线的峰值波幅  */
double Measure::e(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
double Measure::aws_da(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
double Measure::aws_db(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
double Measure::aws_dc(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
double Measure::aws_dd(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
double Measure::aws_d45(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
double Measure::aws_d60(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
double Measure::aws_d70(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
double Measure::aws_dcl(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
double Measure::t_d_r(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
double Measure::t_d_m(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
double Measure::t_s_mr(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
...
double Measure::t_d_mr(const DplDevice::GroupPointer &group)
{
    qDebug()<<__FILE__<<__func__<<"Unimplemented";
    return 0;
}
