...
void DrawDxf::paint_arc(QPainter &painter)
{
    ...
    for(int i = 0; i < d->m_arcList.count(); i++){
        ...
        QPointF _point1 = coordinate_trans(d->m_arcList.at(i).cx * d->m_arcList.at(i).ez,
                                           d->m_arcList.at(i).cy, false);
...
void DrawDxf::paint_circle(QPainter &painter)
{
    ...
    for(int i = 0; i < d->m_circleList.count(); i++){
        ...
        QPointF _point1 = coordinate_trans(d->m_circleList.at(i).cx * d->m_circleList.at(i).ez,
                                           d->m_circleList.at(i).cy, false);
        QPointF _point2 = coordinate_trans(r, r, true);
