...
VYWeldWidget::VYWeldWidget(QSharedPointer<BaseWeldInformation> &weldInfo) : BaseWeldWidget(weldInfo)
{
...
void VYWeldWidget::paint()
{
    ...
    /* point4 */
    QPoint point4(this->width() / 2 - tmpInfo->get_W3() * tmpInfo->get_width_scale(), top + (tmpInfo->get_H1() + tmpInfo->get_H2()) * tmpInfo->get_height_scale());
    /* point5 */
...
void VYWeldWidget::paint_symbol()
{
