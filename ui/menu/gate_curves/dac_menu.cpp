    ...
    : BaseMenu(ui, parent)
{
    ...
    m_curveNoItem = new SpinMenuItem;
    m_curveNoItem->set(tr("Curve No."), "", 1, 5, 0);

    m_curveXItem = new ComboMenuItem;
    m_curveXItem->set(tr("Curve X"), curveXList);

    m_dbOffsetItem = new SpinMenuItem;
    m_dbOffsetItem->set(tr("dB Offset"), "dB", -40, 40, 1);

    m_refGainItem = new SpinMenuItem;
...
DacMenu::~DacMenu()
{
    ...
    /* Setting */
    delete m_curveNoItem;
    delete m_curveXItem;
    delete m_dbOffsetItem;
    delete m_refGainItem;
    delete m_switchItem;

    /* Edit */
    delete m_pointItem;
    delete m_positionItem;
    delete m_addPointItem;
    delete m_deletePointItem;
}
