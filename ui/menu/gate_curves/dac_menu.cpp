...
void DacMenu::hide_setting()
{
    ...
    ui->layout4->removeWidget(&m_refGainItem);
    ui->layout5->removeWidget(&m_switchItem);
    m_modeItem.hide();
    m_curveNoItem.hide();
    m_curveXItem.hide();
    m_dbOffsetItem.hide();
...
void DacMenu::hide_edit()
{
    ...
    ui->layout3->removeWidget(&m_addPointItem);
    ui->layout4->removeWidget(&m_deletePointItem);
    m_modeItem.hide();
    m_pointItem.hide();
    m_positionItem.hide();
    m_addPointItem.hide();
