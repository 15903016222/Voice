    ...
    BaseMenu(ui, parent)
{
    ...
    m_positionStartItem = new SpinMenuItem;
    m_positionEndItem = new SpinMenuItem;
    m_offsetStartItem = new SpinMenuItem;
    m_offsetEndItem = new SpinMenuItem;
...
{
    delete m_typeItem;
    delete m_positionStartItem;
    delete m_positionEndItem;
    delete m_offsetStartItem;
    delete m_offsetEndItem;
}
